...
const VIEWS = [
  ...
  ['fps-picnic.png', -122.7079875, 45.4985855, 150, -6],   // on the lawn, looking at an A-frame picnic table (SSE)
];
...
(async () => {
  ...
  console.log('picnic:', await page.evaluate(() => window.__picnicCount && window.__picnicCount()));
